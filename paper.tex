...
trees [TODO cite examples from \#38]. While this statement
...
% per site per generation may be easier to follow?
\SI{5.49e-9}{site^{-1}generation^{-1}} and a recombination rate of
\SI{8.4e-9}{site^{-1}generation^{-1}} [CITE stdpopsim] and a constant effective population size of 
1,000,000.
...
The number of nodes in Fig.~\ref{fig-inferred-args} C
