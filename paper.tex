...
ARG into a retrospective one is a powerful tool,
with other applications as we discuss in the following sections.

\section*{Ancestry resolution}\label{Ancestry_resolution}

These genomic intervals, directly ancestral to the samples
and  scattered across a set of lineages at some time in the past,
