...
% Note: we want some terminology here to be precise about what we're
% talking about - perhaps a G-ARG for genome-ARG vs E-ARG for event?
% Just using ARG for now, can clean up in another pass.
