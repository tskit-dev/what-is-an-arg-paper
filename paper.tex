...
One source of differences between 
the inferences is the underlying model. For instance, 
the ARG in Fig.~\ref{fig-inferred-args}A is inferred 
under parsimony, and therefore has many fewer 
ancestral nodes then Fig.~\ref{fig-inferred-args}B, which 
is sampled from the coalescent with recombination with an 
appropriate recombination rate parameter. Such differences
are well understood.
...
[WIP] The differences between ARGs that we wish to draw attention to here 
are more subtle
