...
We show that the gARG encoding can fully capture the richness of modern large-scale datasets
...
all recombination events to be detailed,
...
Just as this true, species ARG unquestionably exists,
it can also never be entirely known.
% TODO: I'm not happy with the phrasing here, anyone want to jump in?
Even if a species
had a sufficiently high mutation rate to identify every
recent branching point uniquely (and somehow managed to survive)
this high rate of mutations would inevitably obscure
more ancient structure.
% Must be a citation for this?
Similarly, it seems unlikely that the details
...
agricultural datasets are even more
detailed~\citep[e.g.][]{hayes20191000,Ros-Freixedes2020}.
While we are not sequencing the entire species yet,
...
is a powerful model that defines a distribution of ARGs
...
ARG data structure, based on recording specific genomes and their intervals of
genetic inheritance. We call this the ``genome ARG'', or gARG encoding. We
...
``event ARG'' or eARG encoding. We show that the new gARG encoding it is a
...
We are not questioning the form of the true ARG, or its existance.

% A data structure is a means of encoding information, and
% a precise description of the structure allows us to mathematically
