...
A suite of ARG evaluation metrics, that take into account more of the
...
This may not be obvious. For example, in the gARG encoding depicted in Figure \ref{fig-ancestry-resolution}C
...
information cannot be recovered from the gARG encoding use in that figure,
so alternative conventions must be introduced to resolve such ambiguities;
