...
% We could also refer to Fig.~\ref{fig-arg-data-structure} if we want a simple picture
% to go with this
...
% Do we need the following caveat?
...
with breakpoints only associated with this specific node type).
...
as used in the ``\nameref{ARG_inference_methods}'' section),
...
Fig.~\ref{fig-arg-data-structure} is the inability to represent
