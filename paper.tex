...
and node dates are not required for our purposes here.
...
(the encoding) are
% WIP - it's surprisingly hard to find papers where an ARG is defined
% concretely
mathematically defined~\citep[e.g.][]{
gusfield2014recombinatorics,ignatieva2021kwarg}
