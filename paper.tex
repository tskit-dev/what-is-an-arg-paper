...
The relationship between an ARG and the corresponding local
% TODO do we mention "marginal" anywhere? Might not be worth the
% effort, surely "local" is clear?
is somewhat subtle (see section XXX), and it useful to have
a concrete definition and process for reconstruction.
...
we an edge $(c, p, I) \in E$ such that $u = c$ and $x \in I$, and set
$\pi_c \leftarrow p$. The set $u \leftarrow p$, and repeat
