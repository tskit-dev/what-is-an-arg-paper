...
edge ordering rules. A third (technically optional, but practically useful)
change is to describe recombinations in terms of two parental genomes
rather than a single node representing either the recombination event or
the gamete in which recombination has occurred.
