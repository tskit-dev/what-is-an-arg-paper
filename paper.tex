...
in terms of evolutionary events, and emphasise the exhaustiveness
of the record (full, complete). We will examine the consequences of both
of these properties in different contexts throughout the remainder of
this article.
...
% inherited.
Classically, this is done by having two different types
of node:
...
We use a common convention here
that the order of parents
is significant, but additional information is sometimes incorporated to
distinguish left and right parents
\citep[e.g.][]{gusfield2014recombinatorics,ignatieva2021kwarg}.
...
\end{tikzpicture}
\caption{\label{fig-arg-data-structure}
A classical event ARG (left) and a corresponding
