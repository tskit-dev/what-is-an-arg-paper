...
among ancestral lineages was formalised by Griffiths and colleagues as a
...
a \emph{realisation} of such a random process or of an
...
\citep{song2004minimum,song2005efficient,rasmussen2014genome,heine2018bridging,ignatieva2021kwarg}.
In this Griffiths encoding, as well as nodes marking sampling events,
we have two additional node types in the graph,
...
Note also that polytomies (e.g.~Fig.~\ref{fig-simplification} node \noderef{k})
are a natural feature of such a Wright-Fisher model
...
Fig.~\ref{fig-simplification}A is original simulation output in
...
persist across multiple trees, naturally captured by the gARG approach.
...
In Fig.~\ref{fig-simplification} we provide a schematic of the events (coloured red and blue squares) and
