...
Aside from the stochastic process interpretation, there
is another concept of an ARG that we must be careful to distinguish,
that of the \emph{actual} ARG underlying a sample of genomes
...
Just as this true, ideal ARG unquestionably exists it
can also never be entirely known
