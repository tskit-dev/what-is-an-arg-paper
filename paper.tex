...
a larger graph than the Hudson algorithm (see the ``\nameref{Ancestry_resolution}'' section),
...
discrete generations and carry two genomes.
% Each individual (labelled
% $I_1$ to $I_8$) therefore has a maternal and paternal genome,
% although the pedigree is only shown for concreteness, and
