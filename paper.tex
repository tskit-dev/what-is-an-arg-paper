...
The structure representing this ensemble of correlated local
trees is usually referred to as an ancestral recombination graph (ARG).
...
We argue, moreover, that the precise estimates of
\emph{all} events required
by such formalisms are fundamentally unsuited to the realities
...
we avoid the necessity of exhaustively listing (and estimating)
