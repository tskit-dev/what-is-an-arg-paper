...
\affil[2]{School of Mathematics and Statistics, University of Glasgow, UK}
\affil[3]{Department of Statistics, University of Oxford, UK}
\affil[4]{School of Mathematics, Statistics and Physics, Newcastle University, UK}
\affil[5]{Department of Statistics, University of Warwick, UK}
\affil[6]{The Roslin Institute and Royal (Dick) School of Veterinary Studies, University of Edinburgh, UK}
\affil[7]{Broad Institute of MIT and Harvard, Cambridge, USA}
\affil[8]{Department of Genetics, Stanford University School of Medicine, Stanford, USA}
...
% assumes all events are \emph{knowable}, and does not
necessitates that all events are recorded explicitly, and does not 
...
necessarily attempt to infer events that are not \emph{knowable} from the data, particularly
