...
[NOTE: we could move this to the later section currently
called "the equivalence of ARGS and the local trees",and
refocus a bit to "ARGs and local trees".]
The relationship between an ARG and the corresponding local trees
is subtle (see section XXX), and it is useful to have
...
``the phylogeny'')
% TODO add more if we keep this. Anyone who says "the ARG is"
