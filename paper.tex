...
Graphics on the bottom row show the genomic positions, relative to the start of the ADH gene,
...
trees \citep{hejase2020summary, ignatieva2021kwarg}. While this statement
...
\SI{5.49e-9}{per site per generation} and a recombination rate of
\SI{8.4e-9}{per site per generation} \citep{lauterbur2022expanding}, together with
...
with recombination \citep{marjoram2006fast}).
