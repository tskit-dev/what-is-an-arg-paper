...
as consisting of a complete record of the genealogical history
...
questioning, however, whether such complete and precise information is
realistically available, and in particular whether our
\emph{representation} of genealogical history should require
such precision.
...
the \citet{kreitman1983nucleotide} \emph{Drosophila melanogaster} dataset
(classically used as a benchmark for ARG inference),
