...
% NOTE: preempting some discussion here:
% Mutation rate is (a) not high enough in existing species to
% resolve, (b) probably couldn't be if organisms are to survive,
% and (c) such a high mutation rate would probably even obscure
% the more ancient past.
...
% Mathematical models are insufficient to describe the complexities
% of biological reality when sampling is at population scale,
% and the true ARG can never be known in its entirity.
...
% This ideal ARG is also not a sample from the coalescent
% or any other population genetics model: by necessity, and design,
% such mathematical constructs are caricatures of biological reality,
% allowing us to draw general conclusions about population processes
% without the burden of unnecessary detail.
% The scale of present-day datasets breaks fundamental assumptions
% made by such models, and we must therefore be careful to articulate
% our goals in inference.
