...
the \emph{outcome} of such a random process or an inference
...
the original stochastic process definition leads to an overly
...
process (see Appendix~\ref{sec-arg-history}),
the classical definition of an ARG data structure is in terms of evolutionary
\emph{events}.


and we therefore refer to it as an ``event ARG'' (eARG).
