...
arenas2013importance,hubisz2020inference,zhang2023biobank}.
While there is of course a single ``true'' ARG that describes
the actual history of a sample, in reality there will be astronically
many ARGs that are compatible with the data, even under
parsimony conditions or when sampling from a model.
There are many different levels of granularity at which we
can reason about recombination, and many different ARGs.
