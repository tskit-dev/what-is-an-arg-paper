...
% Other representations of ARGs, beyond straightforward implementations
% of a Griffiths-style
% eARG~\citep[e.g.][]{ignatieva2021kwarg,rasmussen2014genome}
% and \texttt{tskit}'s gARG format, are of course possible.
% The ARGON simulator~\citep{palamara2016argon}, for example,
% stores ARGs
% ARG-Needle~\citep{zhan2023towards}, for example, uses a format based
% on hap
...
``event'' ARG (eARG), which is more limited in what can be described,
because of its origins in an idealised mathematical model,
and the assumption of having complete information about
recombination events.
...
precise information about recombination is therefore a fundamental limitation, which
...
of contemporary datasets and describing important forms of temporal uncertainty.
