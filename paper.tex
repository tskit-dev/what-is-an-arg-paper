...
Inferring the genealogical relationships between sampled genomes in the form of an
...
depends on summaries ultimately derived from the trees
% TODO cite the other papers that preceded ralph2020efficiently here.
such as allele frequencies and site frequency spectra~\citep{ralph2020efficiently}, patterns of linkage
