...
The arity of a node is the number of child nodes it has. There is an
...
which we illustrate by an example simulation.
[THIS SIMULATION...]
...
(legend in Fig.~\ref{fig-inferred-args})
...
(D) Rewrite edges to bypass nodes where they are locally unary.
}
\end{figure}
