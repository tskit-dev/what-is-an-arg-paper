...
% TODO rephrase, this is wooly now
...
% Note: I started off talking about the "ultimate" ARG of everone
% who ever lived, but didn't find it that helpful.
True ARGs are the actual history,
...
Although population ARGs unquestionably exist,
they can also never be entirely known because of a fundamental
...
entire ARG is known with complete precision,
...
% Tedious to cite again, but I don't want to leave Relate out of the
% motivatory discussion
...
instead of a complete, fully detailed history.
% Not sure the point is coming across that well here, but it's a
% really important point and a significant
...
such as the coalescent. % with recomb is surely unnecessary here
...
zhang2023biobank},
there is no corresponding mathematical description
...
interoperate. The SAM/BAM file format~\citep{li2009sequence}
...
SAM/BAM has since become ubiquitous in bioinformatics pipelines.
...
software library that \emph{implements} SAM/BAM and several other
foundational bioinformatics file formats.
Today, there are dozens  % hundreds? Could check on github I guess?
of tools that use \texttt{htslib} to
support SAM/BAM and it this shared use of community software
