...
events.
% Wilder: important to get this point into the intro
We argue that while adopting the general concept of an ARG data structure
is useful, it is important that we then fully decouple this data structure
from the original stochastic process.
[MORE]
