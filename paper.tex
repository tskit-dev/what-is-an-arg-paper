...
impede progress in applying genetic genealogies to understand the biological world \citep{lewanski2023era}.
...
% downstream algs
The gARG encoding
allows us to do this X once and to store the result, whereas
the eARG encoding requires us to repeat the process of X
each time.
...
or many children (a node with more than two children is known as a polytomy).
