...
\paragraph*{Properties of the coalescent with recombination and related models}
...
\paragraph*{Inference of evolutionary parameters and genealogies}
...
\paragraph*{Optimisation problems for phylogenetic networks}
...
\paragraph*{} The goal of this historical overview is to illustrate that the meaning of the term ``ARG" now strongly
