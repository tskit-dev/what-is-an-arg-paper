...
arbitrary patterns of genetic inheritance such as gene conversions,
multiple recombinations and so on can be directly expressed.
...
is usually much more useful and, indeed, all that is possible to
...
Another key factor in the how important ARG-based methods become
across the wide range of predicted application
areas [CITE commentary pieces, tsinfer, ARGneedle any others?]
is how well inference methods and downstream analysis applications
interoperate. [Genetics doesn't have a good record here, let's
...
simulator~\cite{kelleher2016efficient} and subsequently been
...
significant confusion. [Discuss, and finish on a positive note]
