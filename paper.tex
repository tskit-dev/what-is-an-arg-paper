...
e.g.~\citep{gusfield2014recombinatorics}); the following is useful
to illustrate the computational properties of the structure.
% It would be slightly easier for us if we defined nodes as in N_0, since
% we use 0 as a node ID, but leaving for now.
We define an EARG as a tuple $(e, \sigma)$, where $e$ is an ordered
