...
\citet{mathieson2020ancestry} and others
...
\begin{figure}
  \begin{subfigure}[b]{0.25\textwidth}
    \centering
    \includegraphics[height=0.3\textheight]{illustrations/pedigree}
    \caption{Pedigree with genetic inheritance}
    \label{fig:pedigree}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.25\textwidth}
    \centering
    \includegraphics[height=0.3\textheight]{illustrations/pedigree_ARG}
    \caption{Graph representation of genetic inheritance}
    \label{fig:ARG-of-pedigree}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.4\textwidth}
    \centering
    \includegraphics[height=0.3\textheight]{illustrations/pedigree_trees}
    \caption{Tree representation of genetic inheritance}
    \label{fig:ts-of-pedigree}
  \end{subfigure}
