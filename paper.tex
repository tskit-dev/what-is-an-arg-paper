...
coalescence and recombination events in the history of a sample,
...
genome. Rather, a genome can be associated with (or ``tag'') an event above or below it (and as argued in
...
divisions from the event itself).
