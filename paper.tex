...
with millions of animals and extensive SNP array genotype data. For example,
...
holder is bull Toystory that has produced 2.4 million doses of semen
...
Effective population size in pigs is also less than 100 with each female and male
routinely producing respectively more than 10 and 5000 progeny each \citep{Hall2016,Porcnic2016}.
...
While the coalescent model can be suprisingly robust
...
whenever a recombination is traversed. Methods based the backwards-in-time approach are described by
...
so parsimony-based methods resort to heuristics and are limited to analysing hundreds of sequences.
