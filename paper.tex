...
Genome ARGs are concerned with
describing the details of genetic inheritance
between specific pairs of genomes.
In contrast, ARGs are classically seem as being defined
by the evolutionary \emph{events} in the history of a sample.
The difference between gARGs and this prevalent view of
what defines an ARGs is subtle and the distinctions sometimes porous.
...
This is assumed to follow the mechanism described by
...
% TODO list papers where people use ordering? ARGweaver I think?
is significant,
but additional information is sometimes incorporated to
