...
ARG inference was for many years synonymous with estimating realisations
...
specific mutational patterns [CITES] and the persistance of a particular 
haplotype over many generations. A ``genome'' in our usage corresponds to the 
...
\footnote{We use the standard graph theoretic sense of
