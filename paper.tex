...
local trees.
The recent
\espalier~\citep{rasmussen2022espalier} ARG inference method
is illustrative in this context.
\espalier\ works by splitting an input sequence alignment into
...
This denormalisation of the gARG data model in is for efficiency purposes.
